...
def roc_auc(true_target, prediction_prob, target_levels):
    ...
    return metrics.roc_auc_score(
        true_target, prediction_prob, multi_class="ovo", labels=target_levels
    )
...
def get_validation_metrics(
    metric_names, true_target, prediction, pred_prob, target_levels
):
    ...
    validation_metrics = {
        metric_name: get_metric(
            metric_name, true_target, prediction, pred_prob, target_levels
        )
