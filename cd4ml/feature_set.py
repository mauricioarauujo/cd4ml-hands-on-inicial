...
class FeatureSetBase:
    ...
    def base_feature_fields(self):
        return (
            self.base_feature_fields_numerical()
            + self.base_feature_fields_categorical()
        )
    ...
    def derived_feature_fields(self):
        return (
            self.derived_feature_fields_numerical()
    ...
    def encoded_feature_fields_numerical(self):
        return _exclude(
            self.available_feature_fields_numerical(),
            self.params["encoder_excluded_fields"],
        )

    def encoded_feature_fields_categorical(self):
        return _exclude(
            self.available_feature_fields_categorical(),
            self.params["encoder_excluded_fields"],
        )

    def encoded_feature_fields(self):
        return (
            self.encoded_feature_fields_numerical()
            + self.encoded_feature_fields_categorical()
        )
    ...
    def ml_fields(self):
        ...
        categorical_n_levels_dict.update(
            self.params["derived_categorical_n_levels_dict"]
        )

        cat_encoded = {
            k: v
            for k, v in categorical_n_levels_dict.items()
