from cd4ml.problems.houses.features.feature_sets.default.feature_set import (
    FeatureSet as FeatureSetDefault,
    get_feature_set_params as get_feature_set_params_default,
)
from cd4ml.problems.houses.features.feature_sets.simple.feature_set import (
    FeatureSet as FeatureSetSimple,
    get_feature_set_params as get_feature_set_params_simple,
)
...
feature_set_params_default_provided = {
    ...
    "base_categorical_n_levels_dict": {"zipcode": 50000, "style": 50},
...
feature_set_params_simple_provided = {
    ...
    "extra_information_fields": [],
    "base_categorical_n_levels_dict": {"zipcode": 50000, "style": 50},
    "base_fields_numerical": ["lot_size_sf", "beds", "baths", "square_feet"],
    "derived_categorical_n_levels_dict": {"state": 100},
    "derived_fields_numerical": ["avg_price_in_zip"],
    "encoder_excluded_fields": [],
    "encoder_untransformed_fields": ["zipcode"],
}
...
def check_feature_set(use_json_file, feature_set_class):
    if feature_set_class == FeatureSetDefault:
        ...
        derived_info = {"state": "MA", "avg_price_in_zip": 700000}
    ...
    feature_set = feature_set_class(
        identifier_field, target_field, info, feature_set_params
    )
