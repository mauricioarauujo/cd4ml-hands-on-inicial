...
def get_message(
    model_id, metric_name, metric_value, threshold_min, threshold_max, accepted
):
    qualifier = "" if accepted else "NOT "
    message = (
        f"Metric: {metric_name} for Model: {model_id} was {qualifier}accepted, "
...
def parse_arguments(args):
    ...
    parser.add_argument(
        "model_id", help="The model_id folder to use to report", nargs="?", default=None
    )
